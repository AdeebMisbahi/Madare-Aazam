      ...
      <div className='bg-gray-50 rounded-lg p-[5vw]'>
          <div className='relative grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 lg:gap-x-6 mx-auto max-w-7xl'>
            <div className='col-span-full flex flex-col justify-center lg:col-span-5 lg:mt-0'>
                ...
                <h2 className='text-2xl md:text-3xl font-matter-m  leading-tight lg:leading-relaxed   text-black mt-12'>Allama Peer Khowaja Syed Misbahul Murad Makanpuri</h2>
                <p className='text-2xl font-matter-m leading-tight lg:leading-relaxed md:text-3xl text-gray-400 mt-8'>
                Revered as 'Jaane Wali' and 'Misbahe Wali' — A Distinguished Scholar and Illuminating Poetic Visionary
                </p>

            </div>
            <div className='relative col-span-full lg:col-span-6 lg:col-start-7 lg:block'>
