...
const IntroSection = () => {
  return (
    <>
       <div className=''>
        <div className='mx-[5vw] rounded-md my-10 bg-[#f7f7f7]'>
            <div className='p-4 relative grid grid-cols-2 gap-12'>
            <div>
           ...
           <div className='flex flex-col justify-center gap-2  items-start pr-5'>
            <h1 className='leading-tight lg:leading-relaxed font-matter-b text-3xl md:text-4xl'>
                Zinda Shah Madar: The Living Sufi Saint
            </h1>
            <p className='py-4 leading-relaxed lg:leading-loose tracking-tight font-merienda-s text-xl md:text-2xl text-gray-400'>
            ...
            <div className=''>
                <p className='p-4 leading-relaxed lg:leading-loose tracking-tight font-merienda-s text-xl md:text-2xl text-gray-400'>
