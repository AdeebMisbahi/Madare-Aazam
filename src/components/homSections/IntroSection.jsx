    ...
    <>
       <div className='m-[4vw]'>
        <div className='bg-gray-50 rounded-lg p-[5vw]'>
            ...
            <div className='col-span-full md:col-span-5 flex flex-col justify-center gap-2  items-start'>
           ...
           <div className='col-span-full  md:col-span-7 pb-4'>
            <img className='h-full w-full rounded-lg' src={IntroSectionPic} alt="" />
