  ...
  return (
    ...
    <div className=''>
      ...
      <div className='col-span-full lg:mb-0 md:col-span-7 md:col-start-6 lg:px-0 shadow-md h-[100vw] md:h-[50vw]'>
        ...
        <div className='col-span-full md:col-start-2 md:row-start-2'><div className='flex flex-auto flex-col items-start '>
        ...
        <div className='col-span-full md:col-start-1 md:row-start-1 md:flex md:flex-col md:col-span-5 h-[100vw] md:h-[50vw]'>
            <img className='h-full w-full object-cover object-center' src={HeaderPic2} alt="" />
          </div>
